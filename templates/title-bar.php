...
<!-- 					<a class="default-btn w-arrow book-btn" href="https://www.fresha.com/providers/id7x9ky5?pId=452325"><span class="fusion-button-text">Book Now</span></a>
					 -->
					<?php if( get_field('sub_content') ): ?>
					<div class="pagetitle-sub-content">
